        ...
        if ($this->backpackapiversion == OPEN_BADGES_V2) {
            if ($this->isuserbackpack) {
                ...
                foreach ($mapping as $map) {
                    ...
                    $numargs = count($map);
                    if ($numargs == 9) {
                        $this->mappings[] = new backpack_api_mapping($map[0], $map[1],$map[2],$map[3],$map[4],$map[5],$map[6],$map[7],$map[8]);
                    } elseif ($numargs == 10) {
                        $this->mappings[] = new backpack_api_mapping($map[0], $map[1],$map[2],$map[3],$map[4],$map[5],$map[6],$map[7],$map[8],$map[9]);
                    } else {
                        $this->mappings[] = new backpack_api_mapping($map[0], $map[1],$map[2],$map[3],$map[4],$map[5],$map[6],$map[7],$map[8],$map[9],$map[10]);
                    }
                }
            } else {
                $mapping = [];

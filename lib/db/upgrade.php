...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2016052301.02) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2016052301.02);
    }
    ...
    if ($oldversion < 2016052301.04) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2016052301.04);
    }


    if ($oldversion < 2016052301.05) {
            ...
            // Main savepoint reached.
        upgrade_main_savepoint(true, 2016052301.05);
    }
